   ...
   public class Program
    {
        ...
        {
            Random randStat = new Random(DateTime.Now.Millisecond);
            for (int i = 0; i < 40; i++)
            {
                AllStations.Add(new BusStation(randStat.Next(0, 1000000).ToString(), " "));

            }
            //Random RandomArea = new Random(DateTime.Now.Millisecond);
            Random BusNumberRandom = new Random(DateTime.Now.Millisecond);
            Random randIndex= new Random(DateTime.Now.Millisecond);
            //int area = RandomArea.Next(1, 6);

            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0,40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0.7), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2.5) }, BusNumberRandom.Next(1, 999), Area.GENERAL)) ;
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 4), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 3.3) }, BusNumberRandom.Next(1, 999), Area.CENTER));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2.9), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 1.87), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 3.8) }, BusNumberRandom.Next(1, 999) , Area.JERUSALEM));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2.65), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0.9), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 3.4) }, BusNumberRandom.Next(1, 999), Area.SOUTH));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 1.3), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 1.9), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2.5) }, BusNumberRandom.Next(1, 999), Area.GENERAL));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0.87), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 2.8) }, BusNumberRandom.Next(1, 999), Area.CENTER));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 6), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 4.5), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 4.8) }, BusNumberRandom.Next(1, 999), Area.JERUSALEM));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 4.9), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 6.2), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 5.8) }, BusNumberRandom.Next(1, 999), Area.GENERAL));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 6), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 4.5), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 5.2) }, BusNumberRandom.Next(1, 999), Area.NORTH));
            AllBuses.AddBus(new BusLine(new List<BusLineStation>() { new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 0), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 6.25), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 7.4), new BusLineStation(AllStations[randIndex.Next(0, 40)].BusStationKey, " ", 8.5) }, BusNumberRandom.Next(1, 999), Area.SOUTH));
        }
        #region ADD
        ...
        static public void AddNewBus(ref List<BusStation> AllStations, BusCollection AllBuses)//the function add a bus 
        {
            ...
            bool flag = false;
            if (!SearchStat(firstnum, ref AllStations))//cheack if the station already exist
            {
            ...
            if (choose == 1)
            {
                ...
                if (checkRouteExist(NuwBus, AllBuses))//check if there is another line passing the same route
                {
                    return;
                }
                else
        ...
        static public void NewStation(BusCollection AllBuses, ref List<BusStation> AllStations)
        {
            ...
            if (!SearchBus(AllBuses, num, first, last, area))// cheack if the bus exist
            {
                throw new BusException("this bus doesn't exist");
            }
            BusLine bus = ReturnBus(AllBuses, num, first, last, area);
            AddStation_(bus, ref AllStations, AllBuses);// transmits a function that add station
            return;
        }//add  station
        static public void AddStation_(BusLine bus, ref List<BusStation> AllStations, BusCollection AllBuses)
        {
            ...
            do
            {
                ...
                if (bus.CheckStationExist(NewStat))//chaeck if the station exist
                ...
                if (SearchStat(NewStat, ref AllStations))
                {
                    ...
                    bus.AddStations(b);//add the station
                    Console.WriteLine("The station was successfully added");
                }
                else
                {
                    BusStation b = new BusStation(NewStat);//create a new station
                    AllStations.Add(b);//add the station to the station's list
                    bus.AddStations(b);
                }
        ...
        }//cheack  if the station's number is correct
        static public int GetNum()
        {
            ...
            while (num < 0);
            return num;
        }//cheack if the number is correct
        ...
        static public double GetNumDistance()
        {
            ...
            while (distance <= 0);
            return distance;
        }// cheack if the distance is correct
        ...
        static public bool SearchUpsideBus(BusCollection AllBuses, int num, string firstStat, string lastStat, Area area)
        {
            ...
            return flag1;
        }//check if bus is the upside of another bus
        ...
        static public void Delete_(BusCollection AllBuses)
        {
            ...
            return;
        }//delete bus or station according the user's choice       
        ...
        static public void Find(BusCollection AllBuses, ref List<BusStation> AllStations)
        {
            ...
            return;
        }// the function find according the user's choice 
        ...
        static void SearchBusNum(BusCollection AllBuses, int busnum)
        {
            ...
            throw new BusException("This bus doesn't exist");
        }//search if bus number exist
        public static void BusesInRoute(BusCollection AllBuses)//create a line between to stations
        {
